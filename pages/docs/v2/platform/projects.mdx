...
export const meta = {
  ...
  lastEdited: '2020-03-20T02:58:42.000Z'
}
...
You can edit your project’s Git integration settings from project settings. First, select the **Git** menu item from your project settings page.
...
If you haven’t set up your Git integration for [GitHub](/docs/v2/git-integrations/zeit-now-for-github), [GitLab](/docs/v2/git-integrations/zeit-now-for-gitlab), or [Bitbucket](/docs/v2/git-integrations/zeit-now-for-bitbucket), you can set it up from here.
...
If you’d like to disconnect your project from a Git repository, **leave the field empty**.

#### Disconnect Your Personal Account or Team

If you’d like to disconnect your **personal account** or **team** from GitHub, GitLab, or Bitbucket, follow the direction here:
