...
## Serverless Function Body size

The maximum size for the body of a [Serverless Function](/docs/v2/serverless-functions/introduction/) is `6MB`.

If a Serverless Function receives a payload in excess of `6MB` it will return an error - **413: FUNCTION_PAYLOAD_TOO_LARGE**.
